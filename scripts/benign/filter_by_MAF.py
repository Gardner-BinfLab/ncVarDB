...
try:
    ...
    with open(error_file_name, 'w') as error_file:
        error_df.to_csv(error_file, sep="\t", index=False)
    if lineNum < len(df.index):
        print("An unexpected error occurred. "+ str(lineNum) + " lines of the input file have been processed. Variants with 5-20% MAF have been saved.")
        
print("Finished. All variants in the input file have been processed.")
