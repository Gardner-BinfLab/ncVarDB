...
bedtools intersect -v -a 5-20_percent_MAF_nc_dbSNP151.tsv -b ncVar_pathogenic.bed > 5-20_percent_MAF_nc_dbSNP151_within30K.tsv

#add the header
head -1 5-20_percent_MAF_nc_dbSNP151.tsv > tmp
cat 5-20_percent_MAF_nc_dbSNP151_within30K.tsv >> tmp
mv tmp 5-20_percent_MAF_nc_dbSNP151_within30K.tsv
